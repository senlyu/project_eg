...
class GainRecordsBank:
    ...
    def get_gain_records_by_source(self, source):
        return self.by_source[source]

    def get_gain_records_by_year(self, year):
        return self.by_year[year]

    def get_gain_records_by_quarter(self, quarter):
        return self.by_quarter[quarter]

    def get_gain_records_by_ticker(self, ticker):
        return self.by_ticker[ticker]

    def get_gain_records_all(self):
        return self.all
    ...
    def logging(self):
        ...
        for gain_record in self.get_gain_records_all():
